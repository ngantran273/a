...
import { owners } from '../Shedule/tasks';

const appointments = [
  {
    id: 0,
    title: 'Watercolor Landscape',
    startDate: new Date(2021, 12, 23, 9, 30),
    endDate: new Date(2021, 12, 23, 11, 30),
    ownerId: 1,
  }, {
    id: 1,
    title: 'Monthly Planning',
    startDate: new Date(2021, 12, 28, 9, 30),
    endDate: new Date(2021, 12, 28, 11, 30),
    ownerId: 1,
  }, {
    id: 2,
    title: 'Recruiting students',
    startDate: new Date(2021, 12, 9, 12, 0),
    endDate: new Date(2018, 12, 9, 13, 0),
    ownerId: 2,
  }, {
    id: 3,
    title: 'Oil Painting',
    startDate: new Date(2021, 12, 18, 14, 30),
    endDate: new Date(2021, 12, 18, 15, 30),
    ownerId: 2,
  }, {
    id: 4,
    title: 'Open Day',
    startDate: new Date(2021, 12, 20, 12, 0),
    endDate: new Date(2021, 12, 20, 13, 35),
    ownerId: 6,
  }, {
    id: 5,
    title: 'Watercolor Landscape',
    startDate: new Date(2021, 12, 16, 13, 0),
    endDate: new Date(2021, 12, 16, 14, 0),
    ownerId: 2,
  }, {
    id: 6,
    title: 'Meeting of Instructors',
    startDate: new Date(2021, 12, 28, 12, 0),
    endDate: new Date(2012, 12, 28, 12, 30),
    ...
    startDate: new Date(2021, 12, 3, 11, 0),
    endDate: new Date(2021, 12, 3, 12, 0),
...
const FlexibleSpace = withStyles(styles, { name: 'ToolbarRoot' })(({ classes, ...restProps }) => (
  <Toolbar.FlexibleSpace {...restProps} className={classes.flexibleSpace}>
    <div className={classes.flexContainer}>
      <div fontSize="large" htmlColor="#FF7043" />
    </div>
